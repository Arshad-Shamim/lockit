  ...
  return (
    ...
    <div className='conatiner-fluid roboto-regular' style={{height:"100vh"}}>
        <div className='row' style={{height:"100vh"}}>
            ...
            <div className='col-lg-6 col-12 mt-4 border'>
                <div className='container mx-auto mt-4 border'>
                    ...
                    <form>
                        <div class="mb-3">
                            ...
                            <input type="text" name="email_or_user" onChange={(e)=>handleemail(e)} class="form-control w-75" id="exampleInputEmail1" aria-describedby="emailHelp"/>
                            <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label d-block">Password</label>
                            <input type={passwordf?"password":"text"} onChange={(e)=>{setPassword(e.target.value)}} class="form-control w-75 d-inline" id="exampleInputPassword1"/>
                        ...
                        <div class="d-grid gap-2">
                            <button class="btn btn-primary w-75" type="button">Sign in</button>
                        </div>
                    </form>
                    </div>
                </div>
